...
namespace Zomato.Services.EmailAPI.Utility
{
    ...
    {
        public static string GetRegisterUserEmailBody(string userName)
        {
            ...
            sb.Append(".header { background: #C70039; color: #fff; padding: 15px; text-align: center; font-size: 24px; font-weight: bold; border-radius: 8px 8px 0 0; }");
            sb.Append(".content { padding: 20px; text-align: center; color: #333; font-size: 16px; }");
            sb.Append(".button { background: #C70039; color: #fff; text-decoration: none; padding: 10px 20px; border-radius: 5px; display: inline-block; font-size: 18px; margin-top: 15px; }");
